...
.button:hover span:after {
  ...
  right: 0;
    ...
    <body>
        ...
        <h1 align='center' style="color:#000000;font-family:Brush Script MT;">Rocket Race!!!</h1>
    ...
    <button class="button" onClick="history.go(-1);return true;" align="bottom"><span>Back</span></button>
     ...
     <div class="video-section">
            <video id="video-elem" preload="auto" autoplay="true" loop="loop">
                <source src="RaceVideos/RocketRace.mp4" type="Video/mp4">
                Video Not Supported
            </video>
         </div>
        </body>
