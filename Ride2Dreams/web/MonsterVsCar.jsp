...
<body>
     ...
     <div class="content-section">
         <h1 align='center' style="color:#000000;font-family:Brush Script MT;">Monster Vs Car!!!</h1>
...
<div class="video-section">
        <video id="video-elem" preload="auto" autoplay="true" loop="loop">
            <source src="RaceVideos/MonsterVsCar.mp4" type="Video/mp4">
              Video Not Supported
        </video>
</div>
</body>
