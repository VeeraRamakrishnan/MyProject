...
<body>
     ...
     <div class="content-section">
        <h1 align='center' style="color:#000000;font-family:Brush Script MT;">Night Stunt!!!</h1>
...
<div class="video-section">
        <video id="video-elem" preload="auto" autoplay="true" loop="loop">
            <source src="RaceVideos/NightStunt.mp4" type="Video/mp4">
              Video Not Supported
        </video>
</div>
</body>
