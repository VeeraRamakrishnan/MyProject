...
<div class="middle">
    ...
    <p id="demo" style="font-size:30px;font-family:DigifaceWide;color:#FF0099"></p>
    
</div>
  
<div class="video-section">
        <video id="video-elem" preload="auto" autoplay="true" loop="loop">
            <source src="RaceVideos/Valentine.mp4" type="Video/mp4">
               Video Not Supported
        </video>
