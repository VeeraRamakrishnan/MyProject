...
var countDownDate = new Date("Sep 3, 2017 15:37:25").getTime();
...
<body>
    ...
    <p id="demo" style="font-size:30px;font-family:DigifaceWide;color:black"></p>
</div>
  
 <div class="video-section">
        <video id="video-elem" preload="auto" autoplay="true" loop="loop">
            <source src="RaceVideos/CopVsMonster.mp4" type="Video/mp4">
               Video Not Supported
        </video>
